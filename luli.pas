	...
	Procedure AltaProyecto();
			...
			begin
				...
				repeat
					...
					P.COD_EMP:= ax[1];
					writeln(P.COD_EMP);
					writeln('CIUDAD sigue siendo ',P.COD_ciudad);
					readKey();
					op1:=1;
					repeat 																		//Etapa
						ClrScr;
					...
					P.COD_ciudad:= ax[1]; //----->                             //ACA ESTA EL ERROR DE QUE EN CIUDAD MUESTRA QUE ES EMP!!
					P.Cantidades[2]:= 0;
					P.Cantidades[3]:= 0;
					P.Cantidades[4]:= 0;
					writeln('CIUDAD sigue siendo pn',P.COD_ciudad);
					readKey();
					seek(Py,filesize(Py));
					write(Py,P);

					writeln('CIUDAD sigue siendo u',P.COD_ciudad);
					readKey();
					repeat
						ClrScr;
